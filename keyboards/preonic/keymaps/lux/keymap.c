...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_LCTL,  KC_LGUI, KC_LALT, MO(_MOD),LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),

[_LEADERKEY] = LAYOUT_preonic_grid( \
  KC_GESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_GRV, \
  KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_QUOT,  \
  ESCMOD,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_BSPC, \
  KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SFTENT,  \
  KC_LCTL,  KC_LGUI, KC_LALT, MO(_MOD),LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_MOD] = LAYOUT_preonic_grid( \
  KC_F12,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, \
  S_TAB,   KC_PGUP, KC_UP,   KC_PGDN, _______, _______, KC_NLCK, KC_P7,   KC_P8,   KC_P9,   _______, _______,  \
  _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_MPLY, _______, KC_P0,   KC_P4,   KC_P5,   KC_P6,   _______, _______,  \
  _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, _______, KC_PDOT, KC_P1,   KC_P2,   KC_P3,   KC_PENT, _______, \
