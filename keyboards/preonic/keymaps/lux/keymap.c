...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  KC_TILD, KC_LBRC, KC_RBRC, TAB_F,   KC_MINS, KC_PLUS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, KC_PIPE,  \
  _______, KC_LCBR, KC_RCBR, TAB_B,   KC_UNDS, KC_EQL,  _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, \
