...
[_GAMER] = LAYOUT_preonic_grid( \
  ...
  KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SFTENT,  \
  ESCMOD,   L_SWAP,  KC_LGUI, KC_LALT LOWER,  KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_MOD] = LAYOUT_preonic_grid( \
  _______,  BASE,    WINOS,   MACOS,    GAMER,   BACKSP,  COLEMAK, _______, _______, _______, _______, _______, \
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, DEBUG,   MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, BASE,    WINOS,   MACOS,   GAMER,   _______, \
