...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  KC_DEL,   S_A,     S_S,     S_D,     S_F,     KC_ENT,   KC_UNDS,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_DQUO, \
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  KC_DEL,   _______, _______, _______, _______, _______,  KC_MINS,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_DQUO, \
  _______,  _______, _______, _______, _______, _______,  KC_MNXT,   KC_MUTE, KC_LABK, KC_RABK, KC_QUES, KC_CAPS, \
