...
[_ALPHA] = LAYOUT_preonic_grid( \
  ...
  KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SFTENT,  \
  CTRLESC,  KC_LGUI, KC_LALT, L_MOD,   LOWER,   SPACEM,  SPACEM,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  KC_DEL,   S_A,     S_S,     S_D,     S_F,     KC_ENT,   _______,  KC_MINS, KC_EQL,  KC_LCBR, KC_RCBR, KC_DQUO, \
  _______,  S_Z,     S_X,     S_C,     S_V,     KC_BSPC,  _______,  KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, _______, \
  L_MOD,    _______, _______, _______, _______, _______,  _______,  _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END  \
),

[_RAISE] = LAYOUT_preonic_grid( \
  KC_F12,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,    KC_F6,     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, \
  KC_TILD,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,  KC_CIRC,   KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PIPE,  \
  KC_DEL,   _______, _______, _______, _______, _______,  _______,   KC_MINS, KC_EQL,  KC_LCBR, KC_RCBR, KC_DQUO, \
  _______,  _______, _______, _______, _______, _______,  _______,   KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, KC_CAPS, \
