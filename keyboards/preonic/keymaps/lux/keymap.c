...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  KC_ESC,  KC_LCBR, KC_RCBR, KC_ENT,  KC_BSPC, KC_DEL,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_INS,  _______,  \
  _______, KC_LPRN, KC_RPRN, KC_EQL,  KC_MINS, KC_PSCR, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,  \
  _______, KC_LBRC, KC_RBRC, KC_PLUS, KC_UNDS, KC_PAUS, _______, _______, _______, _______, _______, _______, \
