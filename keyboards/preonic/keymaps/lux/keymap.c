...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______,   S_AL,    S_SA,    KC_DEL,  KC_BSPC, KC_ENT,   _______,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  _______,   _______, _______, SWAPL,   SWAPR,   _______,  _______,  KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, DVORAK,  ALPHA, PIPEHITTER, \
