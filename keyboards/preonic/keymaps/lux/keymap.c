...
[_ALPHA] = LAYOUT_preonic_grid( \
  ...
  L_CMD,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
  KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SFTENT,  \
  CTRLESC,  L_MOD,   KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_SWAP] = LAYOUT_preonic_grid( \
  KC_DEL,   KC_0,    KC_9,    KC_8,    KC_7,    KC_6,    KC_5,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL, \
  KC_BSPC,  KC_P,    KC_O,    KC_I,    KC_U,    KC_Y,    KC_T,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,  \
  KC_QUOT,  KC_SCLN, KC_L,    KC_K,    KC_J,    KC_H,    KC_G,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
  KC_SFTENT,KC_SLSH, KC_DOT,  KC_COMM, KC_M,    KC_N,    KC_B,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SFTENT,  \
  ESCMOD,   L_CMD,   KC_LALT, KC_LCTL, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______,  _______, _______, _______, _______, _______,  _______,  _______, KC_HOME, KC_PGDN, KC_PGUP,   \
),
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, DEBUG,   MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, DVORAK,  ALPHA,   GAMER, \
