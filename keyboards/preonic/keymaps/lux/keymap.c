...
#define S_UN LCTL(KC_Z)
#define S_CU LCTL(KC_X)
#define S_CO LCTL(KC_C)
#define S_PA LCTL(KC_V)
#define S_AL LCTL(KC_A)
#define S_SA LCTL(KC_S)
#define S_FI LCTL(KC_F)
...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_LCTL,  KC_LGUI, KC_LALT, MO(_CMD),LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),

[_PIPEHITTER] = LAYOUT_preonic_grid( \
  ESCMOD,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_GRV, \
  KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,  \
  KC_BSPC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
  KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SFTENT,  \
  CTRLESC,  KC_LGUI, KC_LALT, MO(_CMD),LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),

[_COLEMAK] = LAYOUT_preonic_grid( \
  KC_GESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_GRV, \
  KC_TAB,   KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_BSPC,  \
  ESCMOD,   KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT, \
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  KC_DEL,   S_AL,    S_SA,    KC_DEL,  KC_BSPC, KC_ENT,   _______,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
  _______,  S_UN,    S_CU,    S_CO,    S_PA,    KC_ESC,   _______,  _______, _______,  _______, _______, _______, \
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  KC_DEL,   _______, _______, SWAPL,   SWAPR,   _______,  _______,  KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
...
[_MOD] = LAYOUT_preonic_grid( \
  KC_F12,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, \
  _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_NLCK, KC_P7,   KC_P8,   KC_P9,   _______, _______,  \
  _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, KC_P0,   KC_P4,   KC_P5,   KC_P6,   _______, _______,  \
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, KC_PDOT, KC_P1,   KC_P2,   KC_P3,   KC_PENT, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, KC_MPLY, KC_VOLD, KC_VOLU, KC_MNXT  \
),

[_CMD] = LAYOUT_preonic_grid( \
  KC_F12,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, \
  _______, SWAPL,   KC_UP,   SWAPR,   ALTE,    _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,  \
  _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_VOLU, KC_MPLY, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,  \
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, DVORAK,  _______, PIPEHITTER, \
