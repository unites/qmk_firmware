...
[_CMD] = LAYOUT_preonic_grid( \
  KC_F12,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, \
  _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MNXT, KC_MPRV, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_INS,  _______,  \
  _______, S_GUI,   KC_DEL,  KC_BSPC, KC_ENT,  _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,  \
  _______, SWAPL,   SWAPR,   ALTE,    S_TAB,   ALT_TAB, KC_PSCR, KC_SLCK, KC_PAUS, KC_INS,  _______, _______, \
