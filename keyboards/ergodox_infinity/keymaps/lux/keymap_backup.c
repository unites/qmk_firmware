...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        MO(SYMB),       MO(SYMB),     MO(SYMB), MO(SYMB), MO(SYMB),
                                                    KC_LALT,  KC_LGUI,
                                                              KC_PGUP,
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS,KC_LCBR,KC_RCBR,KC_EQL, KC_MINS,KC_BSPC,KC_TRNS,
       ...
       KC_TRNS, KC_ENT,  KC_UNDS,KC_PLUS, KC_LBRC, KC_RBRC, KC_TRNS,
                         KC_TRNS,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
