...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
        ...
        KC_GRV,         KC_ESC,     KC_UP,       KC_ENT,    KC_BSPC,    KC_DEL,     KC_HOME,    KC_PGDN,    KC_PGUP,    KC_END,     KC_INS,     _______,    _______,   _______,
        _______,        KC_LEFT,    KC_DOWN,     KC_RIGHT,  KC_GRV,     KC_TAB,     KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,   _______,    _______,    _______,
    ...
    [_RAISE] = LAYOUT(
        KC_TILD,        RGB_M_P,    RGB_M_B,     RGB_M_R,   RGB_M_SW,   RGB_M_SN,   RGB_M_K,    RGB_M_G,    RGB_RMOD,   RGB_MOD,    RGB_TOG,    RGB_SAD,    RGB_SAI,   DEBUG,  RESET,
        KC_GRV,         KC_ESC,     _______,     KC_ENT,    KC_BSPC,    KC_DEL,     KC_NLCK,    KC_P7,      KC_P8,      KC_P9,      KC_PPLS,    KC_PAST,    _______,   _______,
        _______,        KC_MUTE,    KC_VOLD,     KC_VOLU,   KC_GRV,     KC_TAB,     KC_PDOT,    KC_P4,      KC_P5,      KC_P6,      KC_PMNS,    KC_PSLS,    KC_PENT,
