...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_LCTL,        KC_LGUI,    KC_LALT,     LOWER,     KC_SPC,     KC_SPC,     MO(_MOD),   KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT),
    ...
    [_MOD] = LAYOUT(
        KC_TRNS,        BASE,       ALT,         SPACE,     KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,   KC_TRNS,  RESET,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
        ...
        case SPACE:
          if (record->event.pressed) {
            set_single_persistent_default_layer(_SPACE);
          }
          return false;
          break;
        case LOWER:
